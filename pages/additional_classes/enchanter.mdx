...
| 3    | A **Lifespring cauldron**. A small brewing vessel that can turn any liquid into a minor healing potion (1d8 HP Ud4) once per day. Can be used as a normal cauldron. |
...
A. Unseele silk cape (1 Armor), fine robes, staff of white ash, silver shortsword, 4d6 coins & purse, a small log of valuable gossip.\
