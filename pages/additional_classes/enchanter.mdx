...
| 2    | A **token of a Djinn** made of a piece of smoked glass. The wielder of this token may use it to take the form of a cloud of smoke, becoming insubstantial for Ud6 Minutes. In this form, the user can move through small gaps in doors and cannot be targeted by non-magical attacks. Ud6. |
...
| 4    | A **pan pipe** gifted by a Satyr. When played, hostile animals Nearby are soothed and    |
...
| 6    | A **Nixie's pearl** gathered from the bed of a river that flows from the other side. Removed from its iron tin, it can absorb the effects of an active magical effect. If destroyed, the magic is released.  |
