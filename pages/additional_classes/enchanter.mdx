...
| 3    | A **Pixie cauldron**. A small brewing vessel that can turn any liquid into a minor healing potion (1d8 HP Ud4) once per day. Can be used as a normal cauldron.    |
