...
| :--- | :----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 1    | A spool of **Troll thread** that can be woven into the air to create small, temporary platforms or bridges. Ud6.                                                                                                                                                                                       |
| 2    | A **token of a Djinn** shaped like a coin and made of smoked glass. The wielder of this token may use it to take the form of a cloud of smoke, becoming insubstantial for Ud6 Minutes. In this form, the user can move through small gaps in doors and cannot be targeted by non-magical attacks. Ud6. |
...
| 4    | A **seelie wand** made of carved applewood decorated with grinning faces. The wand can be used to cast **Charm**, **Sleep**, or **Fog** without using a spell slot. Ud6.                                                                                                                               |
| 5    | Iron **wyrd shears**. Ud4. The wielder can cut the threads of fortune for a single target they can see. Targets have terrible nightmares and roll all tests with **Disadvantage** for a day.                                                                                                           |
