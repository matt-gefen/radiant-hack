...
| 2    | A **rune stone**, stolen from a witch of the wood. Ud4. Cast spell from the [Enchanter Starting Spells](/additional_classes/enchanter#enchanter-starting-spells) of level 1-2. |
| 3    | A pouch of **"Catnip"**. Ud8. Take to gain advantage on DEX saves for a 1d4 turns.                                                                                             |
| 4    | A **dagger of returning**. Ud6. A throwing dagger that returns to your hand if it misses its target.                                                                           |
| 5    | A **porcelain mask** that allows one to shroud themselves in a **[Glamour](/magic/arcane_spells#level-2)**. Ud6.                                                               |
...
A - Black leather hood & vest (2 Armor), 2 short swords, 2d8 counterfeit coins, lockpicks.\
B - Cloth gambeson (1 Armor), bow & arrows (Ud8), 3d6 coins, a hooded lantern & a flask of oil.
