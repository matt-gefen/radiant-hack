...
Every Cleric starts with 3d6 coins, torches, rations, a [toolkit](/rules/equipment#toolkits) of their choice, and one of the following sets of equipment:
...
| Powers        | Description                                                                                                                                                                                                                                                                                                                                      |
| :------------ | :----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Rebuke**    | Target [Sum] enemies. Each target must make a DR12 + [Mana] **_WIS_** Test. On a success, they will flee in fear.                                                                                                                                                                                                                                |
| **Replenish** | Target [Mana] allies, who regain [Sum] HP each, not exceeding their maximum HP.                                                                                                                                                                                                                                                                  |
| **Bless**     | Target [Mana] allies they want to bless. The total value of [Sum] becomes a Pool of points that those blessed can tap into at will when making Tests. The Pool lasts until they next **_Rest_**. The moment before an ally needs to roll a Test, they can use up a number of points from the Pool to temporarily raise a single **_Attribute_**. |
...
| **Sanctify**          |                                                                                                        |
| **Miracle**           | Expend a Mana to instantly regain 1d10 HP                                                              |
