...
When rolling an attribute test to see if you hit or are able to avoid taking damage, and subtract your collective Armour Bonus to the dice roll. Example: If you are wearing Leather armour, subtract 2 to the roll.
...
Magic weapons and armour typically add +1 to any attribute being tested whilst using the weapon and +1 to each damage dice rolled. More powerful weapons (+2/3) can be found if the ***GM*** includes them.
