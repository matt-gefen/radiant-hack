...
It can also be done during an adventure, in which case it requires 10 minutes and a ***Spell Attribute*** Test. The desired changes take effect regardless of the outcome, but on a failure, the devotee cannot change ***Miracles*** again until sunrise. 
